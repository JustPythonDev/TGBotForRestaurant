...
""", [
    ...
    ('💬 Рейтинг', 'Выберите категорию', 'feedback', 'start', 5, 'img/feedback.jpg'),
    ...
    ('Оценить ресторан', 'Поставьте вашу оценку', 'set_review', 'feedback', 1, None),
    ('Просмотреть рейтинг', 'Общий рейтинг', 'view_reviews', 'feedback', 2, None)
])
